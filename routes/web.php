...
// Route::post('/carts', 'CartDetailController@atendido')->name('pedidos.store'); //
...
->group(function () {
	...
	Route::get('/products/{product}/edit', 'ProductController@edit')->name('product.edit'); // formulario edición
	Route::put('/products/{product}/edit', 'ProductController@update')->name('product.update'); // actualizar
