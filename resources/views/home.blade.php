...
<div class="main main-raised">
    <div class="container">
        ...
        <div class="section">
                    ...
                    <tr>
                        ...
                        <td class="td-actions">
                            <form method="post" action="{{ url('/cart') }}">
                                ...
                                <a href="{{ route('product.show', $detail->product->slug) }}" target="_blank" rel="tooltip" title="Ver producto" class="btn btn-info btn-simple btn-xs">
            ...
            @else
                <div class="text-center">
                    <h4>Realiza tus pedidos <a href="{{ url('/') }}">aquí</a></h4>
                </div>
            @endif
