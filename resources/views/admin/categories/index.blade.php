                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-actions text-right">
                                    <form method="post" action="{{ url('/admin/categories/'.$category->slug) }}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                        ...
                                        <a href="{{ url('/admin/categories/'.$category->slug.'/edit') }}" rel="tooltip" title="Editar categoría" class="btn btn-success btn-simple btn-xs">
